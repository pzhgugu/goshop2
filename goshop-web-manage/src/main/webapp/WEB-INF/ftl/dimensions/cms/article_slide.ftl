...
<head>
    ...
    <script src="${S_COMMON_URL}/scripts/swiper/swiper-3.3.1.jquery.min.js"></script>
    <script src="${S_COMMON_URL}/scripts/ajaxfileupload/ajaxfileupload.js"></script>
    <link href="${S_COMMON_URL}/scripts/swiper/swiper-3.3.1.min.css" rel="stylesheet" type="text/css"/>
    <link href="${S_COMMON_URL}/scripts/swiper/style.css" rel="stylesheet" type="text/css"/>
...
<#if (P_CSM_SLIDE_LIST?size>1)>
    ...
    <#else>
                <li class="swiper-slide"><img src="${S_COMMON_URL}/images/swiper/swiper1.png"></li>
                <li class="swiper-slide"><img src="${S_COMMON_URL}/images/swiper/swiper2.png"></li>
</#if>
            </ul>
        </div>
