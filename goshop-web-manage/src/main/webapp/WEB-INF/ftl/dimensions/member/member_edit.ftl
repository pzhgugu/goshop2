...
<div class="page">
    ...
    <form method="post" enctype="multipart/form-data" id="user_form">
        ...
        <table class="table tb-type2">
			...
			<div style="display: none;" class="type-file-preview"><img id="view_img" src="<#if (P_MEMBER.memberAvatar??&&P_MEMBER.memberAvatar!='')>${S_URL}/att?path=${P_MEMBER.memberAvatar}<#else>${S_URL}/static/images/default_user_portrait.gif</#if>"> </div>
			</span>
