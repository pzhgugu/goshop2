...
<#if P_CMS_ARTICLE??>
    <input type="hidden" id="articleId" name="articleId" value="${P_CMS_ARTICLE.articleId}">
        ...
        <table class="table tb-type2 nobdb">
			...
			<div class="type-file-preview" style="display: none;"><img id="view_img" src="<#if (P_CMS_ARTICLE??&&P_CMS_ARTICLE.articleImage!='')>${S_URL}/att?path=${P_CMS_ARTICLE.articleImage}<#else>$${S_URL}/static/images/cms/no_cover.png</#if>"> </div>
			</span>
...
<script charset="utf-8" src="$${S_URL}/static/scripts/fileupload/jquery.iframe-transport.js" type="text/javascript"></script>
