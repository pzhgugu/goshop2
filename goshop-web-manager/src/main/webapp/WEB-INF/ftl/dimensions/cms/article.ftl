    ...
    <form method="post" id="list_form">
        ...
        <table class="table tb-type2">
            ...
            <tr class="hover edit" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
                ...
                <i></i>
                <img width="56" height="43" src="<#if ((o.articleImage??)&&(o.articleImage!=''))>${S_URL}/att?path=${o.articleImage}<#else>${S_URL}/static/images/cms/no_cover.png</#if>" onload="javascript:DrawImage(this,56,56);">
            </span></div></td>
