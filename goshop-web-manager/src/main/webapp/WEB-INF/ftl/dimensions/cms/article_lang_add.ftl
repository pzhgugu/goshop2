...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${S_URL}/static/scripts/jquery-ui/themes/smoothness/jquery.ui.css">
    <link id="cssfile2" type="text/css" rel="stylesheet" href="${S_URL}/static/styles/skin_0.css">
    <script charset="utf-8" src="${S_URL}/static/scripts/kindeditor/kindeditor-min.js"></script>
    <script charset="utf-8" src="${S_URL}/static/scripts/kindeditor/lang/zh_CN.js"></script>
...
<div class="page">
    ...
    <#if P_CMS_ARTICLE??>
        ...
        <table class="table tb-type2 nobdb">
			...
			<img class="show_image" src="${S_URL}/static/images/preview.png">
			<div class="type-file-preview" style="display: none;"><img id="view_img"
                                                                       src="<#if (P_CMS_ARTICLE??&&P_CMS_ARTICLE.articleImage!='')>${S_URL}/att?path=${P_CMS_ARTICLE.articleImage}<#else>${S_URL}/static/images/cms/no_cover.png</#if>">
            </div>
			</span>
...
<script charset="utf-8" src="${S_URL}/static/scripts/fileupload/jquery.iframe-transport.js"
        type="text/javascript"></script>
<script charset="utf-8" src="${S_URL}/static/scripts/fileupload/jquery.ui.widget.js" type="text/javascript"></script>
<script charset="utf-8" src="${S_URL}/static/scripts/fileupload/jquery.fileupload.js" type="text/javascript"></script>
...
<script>
    ...
    KindEditor.ready(function (K) {
        KE = K.create("textarea[name='articleContent_zh']", {
            ...
            cssPath: "${S_URL}/static/scripts/kindeditor/themes/default/default.css",
