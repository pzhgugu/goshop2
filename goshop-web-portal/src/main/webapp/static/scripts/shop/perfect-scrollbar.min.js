(function ($) {
    ...
    $.fn.perfectScrollbar = function (suppliedSettings, option) {
        ...
        var $this = $(this).addClass("ps-container"), $content = $(this).children(), $scrollbarX = $("<div class='ps-scrollbar-x'></div>").appendTo($this), $scrollbarY = $("<div class='ps-scrollbar-y'></div>").appendTo($this), containerWidth, containerHeight, contentWidth, contentHeight, scrollbarXWidth, scrollbarXLeft, scrollbarXBottom = parseInt($scrollbarX.css("bottom"), 10), scrollbarYHeight, scrollbarYTop, scrollbarYRight = parseInt($scrollbarY.css("right"), 10);
        ...
        var bindMobileTouchHandler = function () {
            ...
            var startCoords = {}, startTime = 0, speed = {}, breakingProcess = null;
